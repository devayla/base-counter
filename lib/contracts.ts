...
export const CONTRACT_ADDRESSES = {
  ...
  TOKEN_REWARD: process.env.NEXT_PUBLIC_TOKEN_REWARD_ADDRESS || "0x3938FccD0bc0d6C397BAeD45f45681D88f282b6E",
  COUNTER: process.env.NEXT_PUBLIC_COUNTER_ADDRESS || "0x550a90a7E6084845B5B6114C0A2347Ada08E091F",
};
...
export const COUNTER_ADDRESS = CONTRACT_ADDRESSES.COUNTER;

export const COUNTER_ABI = [
  {
    "inputs": [
      { "internalType": "address", "name": "_serverSigner", "type": "address" }
    ],
    "stateMutability": "nonpayable",
    "type": "constructor"
  },
    ...
    "outputs": [
      {
        "components": [
          ...
          { "internalType": "string", "name": "imageUrl", "type": "string" },
          { "internalType": "uint256", "name": "timestamp", "type": "uint256" },
          { "internalType": "uint256", "name": "userTotalIncrements", "type": "uint256" }
        ],
        "internalType": "struct Counter.IncrementInfo[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
  ...
  },
  {
    ...
    "inputs": [
      ...
      { "indexed": false, "internalType": "uint256", "name": "counterValue", "type": "uint256" }
    ],
